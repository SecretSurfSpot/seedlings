...
def setup_test_database
  ...
  connection.exec("INSERT into campaigns(name, image, country, sector, target_amount)
    VALUES('Campaign_1', 'Image_1', 'United Kingdom', 'Automotive', 1000000),
    	  ...
    	  ('Campaign_8', 'Image_8', 'Potugal', 'Tourism', 1500000),
    	  ...
    	  ('Campaign_14', 'Image_14', 'Potugal', 'Electrical', 100000),
    	  ...
    	  ('Campaign_18', 'Image_18', 'Potugal', 'Electrical', 1100000),
  ...
  connection.exec("INSERT into investments(campaign_name, investor_name, amount)
  	VALUES('Campaign_1', 'guest', 10000),
  		  ...
  		  ('Campaign_11', 'guest', 100000),
  		  ('Campaign_12', 'guest', 30000),
  		  ('Campaign_13', 'guest', 40000),
  		  ('Campaign_14', 'guest', 50000),
  		  ('Campaign_15', 'guest', 10000),
  		  ('Campaign_16', 'guest', 90000),
  		  ('Campaign_17', 'guest', 30000),
  		  ('Campaign_18', 'guest', 20000),
  		  ('Campaign_19', 'guest', 70000),
  		  ('Campaign_20', 'guest', 10000);
        ")
end
